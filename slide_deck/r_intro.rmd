...
1. Download this **slide deck** ,  **example datasets** and **exercises** from [https://github.com/hhsievertsen/R_introduction](https://github.com/hhsievertsen/Advanced_R/)
...
- We know that the OLS estimator in matrix form is given by:
...
- Application: estimate the probability that a child  participates in the summer school using a probit model.
